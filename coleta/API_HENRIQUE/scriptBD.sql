...
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'ME';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'FOI';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'COMO';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'MOTIVO';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'VENDI';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'PELO';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'AR';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'LIVRE';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'DINHEIRO';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'MERCADO';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'MINHA';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'MAS';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'DIAS';
DELETE FROM [dbo].[Reclamacoes] WHERE palavra = 'JÁ';